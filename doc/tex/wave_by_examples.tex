...
\begin{figure}[htb]
\centering
\includegraphics[width=1.0\textwidth]     {pics/gut-spect-1a.pdf}
\end{figure}
...
\include{ex8} % Magnetic Field Errors
\include{ex9} % Real Beams, Part 2
\include{ex10} % Parallel Processing
\include{ex11} % UNDUMAG
\include{ex12} % Accelerator Physics
\include{ex13} % User interfaces
\include{ex14} % User interfaces

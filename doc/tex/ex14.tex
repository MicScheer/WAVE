...
Often, ones want to plot only a 2d-cut of the 4d distribution. Then it
is useful, to limit the phasespace to the considered range, since the
calculations can be very time-consuming. Therefore

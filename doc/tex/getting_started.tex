...
working directory. This file defines the menu structure of \WSHE. The
first line contains the command to start \W and can be changed
according to special needs of the user.
The \gtis{Python} script \gtis{../python/waveshop.py} is started by

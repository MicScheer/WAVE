...
\newcommand{\gtis}[1]{\textbf{\color{grau}\textit{\textsmaller[0.5]{#1}}} \color{black}}
\newcommand{\gtise}[1]{\textbf{\color{grau}\textit{\textsmaller[1]{#1}}}\color{black}}
...
\newcommand{\scap}[1]{\textit{\textsmaller[2]{\textbf{\grau #1}}}}
\newcommand{\cbox}[1]{\vspace{0.1cm} \hspace{1cm}\parbox[c]{0.8\textwidth}{\gti{#1}}}

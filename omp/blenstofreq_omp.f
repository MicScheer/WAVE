...
!$OMP& SHARED(mthreads,stokes,obsv,obsvz,obsvy,
!$OMP& iw_circ,if1dim,ipin,ispecana,ipincirc,irphi,wstokes,wstokesf,pinr,pincen)
!$OMP& FIRSTPRIVATE(nfreq,nobsv,istok,nobsvz,nobsvy,
!$OMP& kpincirc_th,krphi_th,mobsv,mobsvy,mobsvz,kstokes)
...
c          IF (kPINCIRC_th.EQ.0.OR.kPINCIRC_th*kRPHI_th.NE.0)
c     &      CALL psplsto_omp(istok,kfreq)
          call blensto_omp(istok,kfreq)

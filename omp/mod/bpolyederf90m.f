...
*CMZ :  4.00/08 06/08/2020  16.13.38  by  Michael Scheer
*CMZ :  4.00/07 05/08/2020  13.32.10  by  Michael Scheer
*CMZ :  3.05/00 26/04/2018  08.48.43  by  Michael Scheer
...
c +DECK,BPOLYEDERF90M,T=F77.
      ...
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: bpebc,bflange,bpefe
     ...
     &  inside,kinside,nthreads,kundurun,jcomment,jrunnum,jdate,kdebug,lunwarn,
     &  ndivfby,lungfo_bpoly

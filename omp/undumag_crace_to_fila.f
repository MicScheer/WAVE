*CMZ :  4.00/11 21/10/2020  09.46.44  by  Michael Scheer
...
*-- Author :    Michael Scheer   08/03/2018
      subroutine undumag_crace_to_fila(k)
...
*KEND.
     ...
     &  delta,ddelta,rr,xx,yy,zz,zcw
      ...
      integer k,iw,ir,nr,nphi,iphi,iy,iz,kolor,ical,istat,i,j,id,
     &  ndelta,iarc1,iarc2,jarc1,jarc2,ihalf1,ihalf2,jhalf1,jhalf2
      ...
      wire(1:10,jarc1:jarc2)=wire(1:10,iarc1:iarc2)
      ...
      wire(1:10,jhalf1:jhalf2)=wire(1:10,ihalf1:ihalf2)

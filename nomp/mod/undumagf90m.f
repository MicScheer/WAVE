...
c +DECK,UNDUMAGF90M.
      ...
      parameter (nthreadp=1000,nwitems=10)
...
!      double precision, dimension (:,:,:,:), allocatable :: wwmatrix
     ...
     &  bpebc0,wire,race,wind,arc,carc,crace,rectbar,thickwire
...
c      real*4, dimension (:,:,:), allocatable :: wwmatrix
     ...
     &  fxdip,fydip,fzdip,
     &  txdip,tydip,tzdip,
     &  uservar(100),corrtiny,hulltiny,randos,randox,randoy,randoz
     ...
     &  iforce,ivrml,iundugeo,iforcedip,iplforce,itorque,mbforcex,mbforcey,mbforcez,mfcolor,
     ...
     &  killbadmag,corrtiny,hulltiny,randos,randox,randoy,randoz,irecrepl

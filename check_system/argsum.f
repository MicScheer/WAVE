...
*KEND.
     ...
     &  DMODU,DMODU0,DDMODU
      ...
      DOUBLE PRECISION OM,DOM,DT,DT2,T
      DOUBLE PRECISION :: RSPECNOR=1.0d0 !11.2.2022

      DOUBLE PRECISION RARG(5),
...
c11.2.2022        RSPECNOR=DSQRT(SPECNOR) to be consistent with hfreq and souintana
        ...
        DO IFREQ=1,NFREQ
          DO JOBSV=1,NOBSV
            ...
            REAIMA(1,1,IOBFR)=0.0d0
            REAIMA(2,1,IOBFR)=0.0d0
            REAIMA(3,1,IOBFR)=0.0d0
            REAIMA(1,2,IOBFR)=0.0d0
            REAIMA(2,2,IOBFR)=0.0d0

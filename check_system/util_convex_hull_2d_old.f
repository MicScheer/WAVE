*CMZ :          30/05/2019  21.21.52  by  Michael Scheer
...
*-- Author :    Michael Scheer   12/04/2016
      subroutine util_convex_hull_2d_old(nin,x,y,nh,ihull,tiny,ifail)
...
! is first point [x(ihull(1)),y(ihull(1))]
     ...
     &  cosmax,cosang,vx1,vy1,vx2,vy2,v(3),v0(3),
     ...
     &  ixmin,ixmax,iymin,iymax,iflat,nin

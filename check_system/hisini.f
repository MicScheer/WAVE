...
*KEND.
      ...
      CHARACTER(1) C1(96)
      CHARACTER(4) CHTAGS(29),chtagsg1(100) !if you change the dimension of chtags here, check all routines with NIDBUNCH
...
999   CONTINUE
      ...
      if (ihbunch.ne.0.and.ispec.ne.0) then
        call hbookm(nidbunch,'beam electrons',29,'//WAVE',nbunch*neinbunch,
     &    chtags)
      endif

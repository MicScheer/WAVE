*CMZ :          04/05/2023  12.51.31  by  Michael Scheer
...
C**********************************************************************
      subroutine bundumap(xin,yin,zin,bxout,byout,bzout,bmxmin,bmxmax)
C**********************************************************************
*KEEP,gplhint.
!******************************************************************************
!
...
*KEND.
     ...
     &  kx1,kx2,kx3,ky1,ky2,ky3,kz1,kz2,kz3,lungfo=16
      ...
      if (ical.eq.0) then
        ...
        open(newunit=lunm,file='undumag.map',status='old')
        ntot=0
        nx=-1
        ny=-1
        nz=0

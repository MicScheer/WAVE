*CMZ : 00.00/19 11/08/2015  16.46.43  by  Michael Scheer
...
*-- Author :    Michael Scheer   21/07/2015
      subroutine util_spline_fit(npar,p,v,ifail)

c +PATCH,//UTIL/FOR
c +DECK,util_spline_fit.


c obsolete, replaced by util_spline_fit_solve

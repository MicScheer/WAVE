...
*CMZ :  2.13/00 02/09/99  17.26.42  by  Michael Scheer
...
*-- Author :
      ...
      PARAMETER(LIDIMP=3,NFREQP=2)

      REAL*4 OBS1Z,FREQ(NFREQP),SPEC(LIDIMP,1,NFREQP),SPECTOT(1,NFREQP)
     ...
     &     RECL=256)
      ...
      DO JLOOP=1,NLOOP(2)
         ...
         READ(LUNU,*)ICODE,OBS1Z
         DO IFREQ=1,NFREQP
           READ(LUNU,*)FREQ(IFREQ)
           READ(LUNU,*)(SPEC(I,1,IFREQ),I=1,LIDIMP),SPECTOT(1,IFREQ)
         ENDDO !IFREQ
99           CLOSE (LUNU)
...
999     CALL LIB$SPAWN('$WAIT 00:00:05')
     ...
     &   ,FORM='FORMATTED',RECL=256,ERR=999)
         DO IFREQ=1,NFREQP
            WRITE(LUNRES,*)ICODE,OBS1Z !FOR NTUPLE
            WRITE(LUNRES,*)FREQ(IFREQ)
            WRITE(LUNRES,*)(SPEC(I,1,IFREQ),I=1,LIDIMP)
            WRITE(LUNRES,*) SPECTOT(1,IFREQ)
         ENDDO !IFREQ
          CLOSE(LUNRES)
